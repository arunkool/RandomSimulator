...
;(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    define(['angular', 'static/app/scripts/Chart_Module/Chart.js'], factory);
  } else if (typeof exports === 'object') {
    module.exports = factory(require('angular'), require('static/app/scripts/Chart_Module/Chart.js'));
  } else {
